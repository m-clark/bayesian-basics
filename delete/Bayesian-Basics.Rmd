...
```{r autocorrExample, eval=T, echo=FALSE, out.width='500px'}
...
```{r posteriorPredictiveExample, eval=TRUE, fig.show='hide', echo=6:14}
load('data/mainModels.RData')
library(rstan)
...
```{r posteriorPredictiveMinComparison, eval=TRUE, fig.keep='none', fig.show='hide', echo=1:7}
...
```{r posteriorPredictiveMinComparisonHist, eval=T, echo=FALSE, out.width='500px'}
...
```{r posteriorPredictive10thComparisonHist, eval=T, echo=FALSE, out.width='500px'}
...
<span style="font-size:.75em">See <span class="func">ppc_stat</span> in <span class="pack">bayesplot</span>.</span>
...
```{r posteriorPredictiveFitted, eval=T, echo=FALSE, out.width='500px'}
...
```
<span style="font-size:.75em">See <span class="func">ppc_scatter_avg</span> in <span class="pack">bayesplot</span>.</span>
...
```{r posteriorPredictiveIndividualy, eval=T, echo=FALSE, out.width='500px'}
...
ggplot(aes(x=yRep), data=gdat) +
  ...
  stat_density(aes(group=as.factor(N)), color='#ff5503', 
...
<span style="font-size:.75em">See <span class="func">ppc_dens_overlay</span> in <span class="pack">bayesplot</span>.</span>
...
<img src="img/posteriorPredictiveResidualRaw.svg" style="display:block; margin: 0 auto;" width=50%>
<img src="img/posteriorPredictiveResidualAvg.svg" style="display:block; margin: 0 auto;" width=50%>


```{r posteriorPredictiveResiduals, eval=T, echo=FALSE}
# marginal distribution check for each y as in BDA 6.5
# library(ggplot2); library(reshape2)
fits = sapply(1:nsims, function(s) X%*%betas[s,])
