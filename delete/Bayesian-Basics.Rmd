...
<img src="img/histofyrepBinom.svg" style="display:block; margin: 0 auto;" width=50%></span>
...
```{r posteriorPredictiveResiduals, eval=T, echo=FALSE, out.width='500px'}
# marginal distribution check for each y as in BDA 6.5
# library(ggplot2); library(reshape2)
fits = sapply(1:nsims, function(s) X%*%betas[s,])
...
```{r maxLikeillustration, cache=FALSE, eval=T, echo=FALSE}
set.seed(1234)
