...
For a reference, the following is from an older version of the Stan manual but I think still helps (see the latest section [here](https://mc-stan.org/docs/2_28/reference-manual/overview-of-stans-program-blocks.html)), and notes variables of interest and the associated blocks where they would be declared.
