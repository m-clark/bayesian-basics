...
We have mentioned that BUGS and JAGS use *Gibbs sampling*, which is a special case of the *Metropolis-Hastings* (MH) algorithm[^MH], a very general approach encompassing a wide variety of techniques.  The Metropolis algorithm can be briefly described in the following steps:
